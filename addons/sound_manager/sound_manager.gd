...
var ui_sound_effects: SoundEffectsPlayer = SoundEffectsPlayer.new(["UI", "Interface", "UI_SFX", "Sounds", "SFX"], 8)
...
func set_volume(bus: String, volume_between_0_and_1: float) -> void:
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index(bus), linear_to_db(volume_between_0_and_1))
